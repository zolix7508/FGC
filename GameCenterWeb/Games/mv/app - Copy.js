...
function App() {
    ...
    self.getData = function () {
        return {
            ...
            currentPlayerLepes: currentPlayerLepes,
            players: players,
            message: message,
        }
    };
...
$(function () {
    ...
    mv.client.playerJoined = function (nick) {
        write({ bold: true, msg: Localizer.playerJoined(nick) });
    }

    mv.client.setStatus = function (mvInfo) {
        var mvParty = $.parseJSON(mvInfo);
        app.updateBoard();
    }
